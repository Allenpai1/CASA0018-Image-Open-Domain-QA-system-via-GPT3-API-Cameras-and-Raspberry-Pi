...
class FRCNN(object):
    ...
    def __init__(self, **kwargs):
        ...
        #---------------------------------------------------#
        #   Get the category and anchor numbers
        #---------------------------------------------------#
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        with torch.no_grad():
            ...
            #-------------------------------------------------------------#
            #   roi_cls_locs  ROI exchange parameter 
            #   roi_scores    Classification score
            #   rois          ROI vertex
            #-------------------------------------------------------------#
        ...
        if crop:
            for i, c in list(enumerate(top_label)):
                ...
                top, left, bottom, right = top-100, left-100, bottom+100, right+100
                ...
                crop_image.save('frames.jpg', quality=95, subsampling=0)
                #return top_label[np.argmax(top_conf)],crop_image
        for i, c in list(enumerate(top_label)):
        ...
        return top_label[np.argmax(top_conf)],image
