...
#--------------------------------------------#
#   code to generate initial anchor
#--------------------------------------------#
...
#--------------------------------------------#
#   expand the anchor to correspond to all feature points
#--------------------------------------------#
def _enumerate_shifted_anchor(anchor_base, feat_stride, height, width):
    ...
    #---------------------------------#
    #   9 anchor bboxs on each grid point
    #---------------------------------#
...
if __name__ == "__main__":
    ...
    height, width, feat_stride  = 38,38,16   # every 16 pixcel in the original picture have a grid
